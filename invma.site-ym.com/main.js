...
const START_URL = "https://invma.site-ym.com/search/custom.asp?id=1505";
const CSV_FILE = 'indiana_vets.csv';
const JSONL_FILE = 'indiana_vets.jsonl';
...
async function scrapeIndiana() {
    console.log("Launching Indiana Master Scraper...");
    ...
    try {
        ...
        console.log("Loading Indiana Search Page...");
            ...
            for (let i = 0; i < pageLinks.length; i++) {
                ...
                try {
                    ...
                    const data = await detailPage.evaluate((sourceUrl, time) => {
                        ...
                        let phoneWork = "";
                        if (tdWorkPhone) {
                            phoneWork = tdWorkPhone.innerText.split('(Phone)')[0].trim();
                        }

                        const tdHomePhone = document.getElementById('tdHomePhone');
                        let phoneHome = "";
                        if (tdHomePhone) {
                            phoneHome = tdHomePhone.innerText.split('(Mobile)')[0].trim();
                        }
